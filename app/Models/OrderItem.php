...
{
     use SoftDeletes;
     protected $fillable = ['price','total_cost','choice_price','discount','discount_ratio','is_vip','status', 'quantity','over_quantity','vendor_benefit','rating','product_id','client_id','order_id'];
     protected $hidden = [
