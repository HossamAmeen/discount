...
<head>
    ...
    <title>{{$configration->website ?? "login form"}}</title>
...
<body class="bg-gradient-primary">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-9 col-lg-12 col-xl-10" style="margin-top: 10%">
                <div class="card shadow-lg o-hidden border-0 my-5">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image"
                                    style="background-image: url(&quot;assets/img/discounts.jpg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">{{$configration->website ?? "login form"}}</h4>
                                    </div>
                                    <form class="user" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group"><input class="form-control form-control-user"
                                                type="text" value="{{ old('email') }}" placeholder="Enter user name..."
