            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">questions</h3>
                        ...
                        <div class="col">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <p class="text-primary m-0 font-weight-bold">update question</p>
                                </div>
                                <div class="card-body">
                                    @if ($errors->any())
                                    ...
                                    action="{{ route($routeName.'.update' , $row->id) }}"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="col">
                                                <div class="form-group"><label
                                                        for="website_name"><strong>question</strong></label>
                                                    <textarea class="form-control" name="question" required>{{$row->question ?? ""}}</textarea>    
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col">
                                                <div class="form-group"><label
                                                        for="website_name"><strong>answer</strong></label>
